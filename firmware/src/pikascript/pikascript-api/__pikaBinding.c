...
PikaObj *New_PikaMain(Args *args){
    ...
    obj_newObj(self, "uct_mouse", "uct_mouse", New_uct_mouse);
#endif
...
void uct_mouse_get_vbattMethod(PikaObj *self, Args *_args_){
    pika_float res = uct_mouse_get_vbatt(self);
    method_returnFloat(_args_, res);
}
method_typedef(
    uct_mouse_get_vbatt,
...
void uct_mouse_initMethod(PikaObj *self, Args *_args_){
    int res = uct_mouse_init(self);
    method_returnInt(_args_, res);
}
method_typedef(
    uct_mouse_init,
...
void uct_mouse_set_motorsMethod(PikaObj *self, Args *_args_){
    ...
    uct_mouse_set_motors(self, left_pwm, right_pwm);
}
method_typedef(
    uct_mouse_set_motors,
    "set_motors", "left_pwm,right_pwm"
);

void uct_mouse_set_polarityMethod(PikaObj *self, Args *_args_){
    int left_polarity = args_getInt(_args_, "left_polarity");
    int right_polarity = args_getInt(_args_, "right_polarity");
    uct_mouse_set_polarity(self, left_polarity, right_polarity);
}
method_typedef(
    uct_mouse_set_polarity,
    "set_polarity", "left_polarity,right_polarity"
);
